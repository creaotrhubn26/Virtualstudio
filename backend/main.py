...
# Split-sheet revenue / payments / invoices routes
try:
    from routes.split_sheets_revenue import router as ss_revenue_router
    app.include_router(ss_revenue_router)
    print("Split-sheets revenue routes loaded")
except ImportError as e:
    print(f"Warning: Split-sheets revenue routes not available: {e}")

# Split-sheet legal-documents generator routes
try:
    from routes.split_sheets_legal import router as ss_legal_router
    app.include_router(ss_legal_router)
    print("Split-sheets legal-documents routes loaded")
except ImportError as e:
...
# Revenue / payments / invoices — extracted to backend/routes/split_sheets_revenue.py.
...
# Legal-documents routes — extracted to backend/routes/split_sheets_legal.py.

...
export const SOUND_LIBRARY: SoundDefinition[] = [
  ...
  // ============================================
  // ENVIRONMENT - Studio ambience
  // ============================================
  {
    id: 'studio-ac-hum',
    name: 'Studio AC Hum',
    nameNo: 'Studio-klimaanlegg',
    category: 'ambience',
    subcategory: 'Studio',
    url: '/audio/ambience/studio-ac-hum.mp3',
    duration: 60,
    loop: true,
    spatial: false,
    defaultVolume: 0.15,
    tags: ['studio', 'ac', 'hum', 'room-tone'],
    description: 'Subtle HVAC room tone typical of a professional studio',
    descriptionNo: 'Subtil romtone typisk for et profesjonelt studio',
  },
  {
    id: 'studio-silent-room',
    name: 'Silent Studio',
    nameNo: 'Stille studio',
    category: 'ambience',
    subcategory: 'Studio',
    url: '/audio/ambience/studio-silent.mp3',
    duration: 60,
    loop: true,
    spatial: false,
    defaultVolume: 0.05,
    tags: ['studio', 'silent', 'room-tone', 'quiet'],
    descriptionNo: 'Romtone for ekko-fritt innspillingsstudio',
  },
  {
    id: 'camera-shutter-burst',
    name: 'Camera Shutter Burst',
    nameNo: 'Kamerautløser (burst)',
    category: 'practical',
    subcategory: 'Camera',
    url: '/audio/practical/camera-shutter-burst.mp3',
    duration: 1.2,
    loop: false,
    spatial: true,
    defaultVolume: 0.6,
    tags: ['camera', 'shutter', 'burst', 'photography'],
    descriptionNo: 'Kamerautløser i seriemodusopttak',
  },
  {
    id: 'camera-shutter-single',
    name: 'Camera Shutter Single',
    nameNo: 'Kamerautløser (enkelt)',
    category: 'practical',
    subcategory: 'Camera',
    url: '/audio/practical/camera-shutter-single.mp3',
    duration: 0.2,
    loop: false,
    spatial: true,
    defaultVolume: 0.6,
    tags: ['camera', 'shutter', 'single', 'photography'],
    descriptionNo: 'Enkelt kameraklikkutløserlyd',
  },

  // ============================================
  // ENVIRONMENT - Fantasy/Atmosphere
  // ============================================
  {
    ...
    category: 'environment',
    subcategory: 'Fire',
    url: '/audio/environment/fireplace.mp3',
    duration: 90,
    loop: true,
    spatial: true,
    defaultVolume: 0.45,
    tags: ['fire', 'fireplace', 'crackling', 'warm', 'cozy'],
    moodTags: ['warm'],
    descriptionNo: 'Bål og peis-lyd for varmt, koselig miljø',
  },
  {
    id: 'cathedral-ambience',
    name: 'Cathedral Ambience',
    nameNo: 'Katedralambians',
    category: 'ambience',
    subcategory: 'Architecture',
    url: '/audio/ambience/cathedral.mp3',
    duration: 120,
    loop: true,
    spatial: false,
    defaultVolume: 0.3,
    tags: ['cathedral', 'church', 'reverb', 'epic', 'sacred'],
    moodTags: ['epic', 'calm'],
    descriptionNo: 'Storartet katedralreverb og fjern korklang',
  },
  {
    id: 'water-stream-gentle',
    name: 'Gentle Stream',
    nameNo: 'Stille bekk',
    category: 'environment',
    subcategory: 'Water',
    url: '/audio/environment/stream-gentle.mp3',
    duration: 60,
    loop: true,
    spatial: true,
    defaultVolume: 0.4,
    tags: ['water', 'stream', 'nature', 'gentle', 'calm'],
    moodTags: ['calm'],
    descriptionNo: 'Rennende bekk i naturlig omgivelse',
  },
  {
    id: 'birds-morning-chorus',
    name: 'Morning Bird Chorus',
    nameNo: 'Morgenfugler',
    category: 'environment',
    subcategory: 'Nature',
    url: '/audio/environment/birds-morning.mp3',
    duration: 90,
    loop: true,
    spatial: false,
    defaultVolume: 0.35,
    tags: ['birds', 'morning', 'nature', 'sunrise', 'outdoor'],
    moodTags: ['calm', 'warm'],
    descriptionNo: 'Morgenfugler som sang ved soloppgang',
  },
  {
    id: 'desert-wind',
    name: 'Desert Wind',
    ...
    category: 'environment',
    subcategory: 'Weather',
    url: '/audio/environment/desert-wind.mp3',
    duration: 60,
    loop: true,
    spatial: false,
    defaultVolume: 0.4,
    tags: ['desert', 'wind', 'dry', 'outdoor', 'arid'],
    moodTags: ['epic'],
    descriptionNo: 'Tørr vind over sandørkenen',
  },
  {
    id: 'crowd-distant-murmur',
    name: 'Distant Crowd',
    nameNo: 'Fjern folkemengde',
    category: 'ambience',
    subcategory: 'Crowd',
    url: '/audio/ambience/crowd-distant.mp3',
    duration: 60,
    loop: true,
    spatial: false,
    defaultVolume: 0.2,
    tags: ['crowd', 'distant', 'people', 'urban', 'ambience'],
    descriptionNo: 'Bakgrunnsstøy fra publikum eller gatemiljø',
  },
  {
    id: 'magical-tones',
    name: 'Magical Ambient Tones',
    nameNo: 'Magiske toner',
    category: 'atmosphere',
    subcategory: 'Fantasy',
    url: '/audio/atmosphere/magical-tones.mp3',
    duration: 120,
    loop: true,
    spatial: false,
    defaultVolume: 0.25,
    tags: ['magic', 'fantasy', 'ethereal', 'mystical', 'atmosphere'],
    moodTags: ['mysterious', 'calm'],
    descriptionNo: 'Delikate magiske overtoner for fantasymiljøer',
  },
];

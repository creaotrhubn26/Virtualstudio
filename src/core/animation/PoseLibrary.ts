...
export const ALL_POSES: PosePreset[] = [
  ...
  {
    id: 'commercial_standing',
    name: 'Profesjonell stående',
    description: 'Upright professional standing pose — natural, confident weight distribution',
    category: 'commercial',
    difficulty: 'beginner',
    pose: {
      [B.SPINE]:           { x: 0.02, y: 0,     z: 0     },
      [B.HEAD]:            { x: 0.05, y: 0,     z: 0     },
      [B.LEFT_SHOULDER]:   { x: 0,    y: 0,     z: 0.04  },
      [B.RIGHT_SHOULDER]:  { x: 0,    y: 0,     z: -0.04 },
      [B.LEFT_ARM]:        { x: 0,    y: 0,     z: 0.12  },
      [B.RIGHT_ARM]:       { x: 0,    y: 0,     z: -0.12 },
      [B.LEFT_FOREARM]:    { x: 0,    y: 0,     z: 0.08  },
      [B.RIGHT_FOREARM]:   { x: 0,    y: 0,     z: -0.08 },
      [B.LEFT_UP_LEG]:     { x: 0,    y: 0.04,  z: 0.04  },
      [B.RIGHT_UP_LEG]:    { x: 0,    y: -0.04, z: -0.04 },
    },
  },
  {
    id: 'seated_confident',
    name: 'Sittende selvsikker',
    description: 'Confident seated pose — upright posture, relaxed arms, slightly forward lean',
    category: 'commercial',
    difficulty: 'beginner',
    pose: {
      [B.HIPS]:            { x: 0.32, y: 0,     z: 0     },
      [B.SPINE]:           { x: -0.05,y: 0,     z: 0     },
      [B.HEAD]:            { x: 0.05, y: 0,     z: 0     },
      [B.LEFT_UP_LEG]:     { x: 1.55, y: 0,     z: 0.12  },
      [B.RIGHT_UP_LEG]:    { x: 1.55, y: 0,     z: -0.12 },
      [B.LEFT_LEG]:        { x: -1.40,y: 0,     z: 0     },
      [B.RIGHT_LEG]:       { x: -1.40,y: 0,     z: 0     },
      [B.LEFT_ARM]:        { x: 0,    y: 0,     z: 0.25  },
      [B.RIGHT_ARM]:       { x: 0,    y: 0,     z: -0.25 },
      [B.LEFT_FOREARM]:    { x: 0.30, y: 0,     z: 0     },
      [B.RIGHT_FOREARM]:   { x: 0.30, y: 0,     z: 0     },
    },
  },
  {
    id: 'dance_arabesque',
